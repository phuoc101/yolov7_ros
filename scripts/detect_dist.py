...
from yolov7dist_ros import YoloV7Dist_ROS  # noqa
...
if __name__ == "__main__":
    ...
    weights_path = os.path.join(YOLOV7_ROOT, rospy.get_param(ns + "weights", "weights/yolov7-tiny.pt"))
    xgb_weights_path = os.path.join(YOLOV7_ROOT, rospy.get_param(ns + "xgb_weights", "weights/xgb_dist.txt"))
    ...
    output_topic = rospy.get_param(ns + "output_topic", "yolov7/detections")
    ...
    detector = YoloV7Dist_ROS(
        weights=weights_path,
        xgb_weights=xgb_weights_path,
